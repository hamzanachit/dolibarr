...
/**
 *	\file       htdocs/core/modules/facture/doc/pdf_brico.modules.php
 *	\ingroup    facture
 ...
 */
class pdf_bricolocal extends ModelePDFFactures
{
    var $db;
    var $name;
    var $description;
	...
	function __construct($db)
	{
		...
		$this->db = $db;
		$this->name = "brico";
		$this->description = $langs->trans('PDFbricoDescription');
		...
		{
			$this->posxdesc=$this->marge_gauche+20;
  		}else{
	...
	function write_file($object,$outputlangs,$srctemplatepath='',$hidedetails=0,$hidedesc=0,$hideref=0)
	{
		...
		if ($conf->facture->dir_output)
		{
			...
			if (file_exists($dir))
			{
				...
				//$conf->global->MAIN_ADD_PDF_BACKGROUND='back.pdf';
	...
	function _tableau_tot(&$pdf, $object, $deja_regle, $posy, $outputlangs)
	{
		...
		if ($deja_regle > 0 || $creditnoteamount > 0 || $depositsamount > 0 && $object->paye==0)
		{
	...
	function _tableau(&$pdf, $tab_top, $tab_height, $nexY, $outputlangs, $hidetop=0, $hidebottom=0, $currency='',$nbpages= NULL)
	{
		...
		if (!empty($this->show_bl_ref))
		{
			$pdf->line($this->posxblref+17, $tab_top, $this->posxblref+17, $tab_top + $tab_height);

				// line prend une position y en 2eme param et 4eme param
			$pdf->SetXY($this->posxblref-1, $tab_top+1);
			$pdf->MultiCell(108,2, 'Ref','','L');
