 ...
 */
class pdf_bricorefpro extends ModelePDFFactures
{
    var $db;
    var $name;
    var $description;
	...
	function _tableau_info(&$pdf, $object, $posy, $outputlangs)
	{
		...
		if ($object->type != 2)
		{
			...
			$pdf->SetFont('', 'B', 8);
			$pdf->MultiCell(100, 3,"Arrêté la présente facture à la somme de :" . ucwords($outputlangs->getLabelFromNumber(round($object->total_ttc,2),1,$conf->monnaie)), 0, 'L', 0);
			$posy = $pdf->GetY() + 1;
