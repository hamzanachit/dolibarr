...
/**
 * \file    test/phpunit/ReleveFunctionalTest.php
 * \ingroup releve
 ...
 * @package Testreleve
 */
class ReleveFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	{
		$this->url('/custom/releve/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('releve/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/releve/admin/about.php');
		$this->authenticate();
		return $this->assertContains('releve/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('relevewidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modReleve_ReleveTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modReleve_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
